...
(() => {
 ...
 function mount(){
  ...
  q('#epShowSaved').onclick=()=>{q('#epPlannedEstimates').open=true;q('#epQuotes').open=true;const list=q('#epSavedPlans');list.querySelector('details')?.setAttribute('open','');list.scrollIntoView({block:'start',behavior:'smooth'});};
