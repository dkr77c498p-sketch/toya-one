...
(() => {
 ...
 const quoteChoices=name=>/仮設/.test(name)?[['養生足場','㎡'],['防音シート張り','㎡'],['散水費','式'],['養生メッシュシート張り','㎡'],['アスベスト含有調査','検体'],['アスベスト含有スレート撤去','㎡']]:/産業廃棄物|処分/.test(name)?[['産業廃棄物運搬費','m³'],['産業廃棄物処分費','m³'],['木くず処分費','m³'],['コンクリート処分費','m³'],['混合廃棄物処分費','m³']]:/解体/.test(name)?[['内部解体','㎡'],['上屋解体','㎡'],['階上解体','㎡'],['基礎コンクリート解体','m³'],['土間コンクリート解体','m³'],['外構撤去','㎡'],['庭石撤去','m³'],['植栽撤去','m³'],['CB撤去','㎡'],['内部残置物撤去','m³']]:/回送|諸経費|福利|値引/.test(name)?[['重機回送費','式'],['諸経費','式'],['値引き','式'],['法定福利費','式']]:/その他/.test(name)?[['解体跡整地','㎡'],['土嚢積み','m']]:[];
