...
(async()=>{
 ...
 find('#pbShowPreview').click();assert.match(find('#pbPreview iframe').srcdoc,/invoice-document/);assert.match(find('#pbPreview iframe').srcdoc,/完了分/);find('#pbPreviewClose').click();
