...
const built=A.build({kind:'wood',area_tsubo:'30',scaffold_m2:'100',sound_m2:'100',asbestos_samples:'2',foundation_m3:'10',grading_m2:'120',overhead_rate:'2',welfare_rate:'1',concrete_haul_price:'1000',concrete_disposal_price:'2000'});
...
assert.equal(A.normalize({kind:'wood',area_m2:'300',floors:'2'}).foundation_m3,'','根拠のない階数別基礎係数を使わない');
assert.equal(A.normalize({kind:'wood',area_m2:'300',foundation_m3:'0'}).foundation_m3,'0','手入力の0を維持');
